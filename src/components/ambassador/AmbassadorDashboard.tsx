    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans" dir="rtl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row gap-6">
        ...
        <aside className="w-full md:w-64 shrink-0 space-y-2">
          ...
          <div className="bg-linear-to-br from-indigo-900 to-slate-900 text-white rounded-2xl p-4 space-y-3 shadow-md border border-indigo-800/50">
                  ...
                  {publicLeads.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {publicLeads.map((lead) => (
                        <div key={lead.id} className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-4 space-y-3 hover:border-indigo-500/50 transition-all shadow-2xs">
                          ...
                          <div className="pt-2 border-t border-slate-200 dark:border-slate-700 flex items-center justify-between gap-2">
                            ...
                            <button
                              ...
                              className="px-4 py-2 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-extrabold transition-all shadow-md shadow-indigo-600/20 cursor-pointer flex items-center gap-1.5"
                            >
                        ...
                        <div key={lead.id} className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-4 sm:p-5 space-y-4 shadow-2xs">
                            ...
                            <div>
                              <div className="flex items-center gap-2">
                                ...
                                {lead.status === "COMPLETED" ? (
                                  ...
                                  <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-extrabold bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 border border-indigo-500/20">
                                    <Clock className="w-3 h-3" />
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs bg-white dark:bg-slate-900 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                            <div className="flex items-center gap-2">
                              ...
                              <a href={`tel:${lead.phone}`} className="font-mono font-bold text-slate-900 dark:text-white hover:text-indigo-600 dir-ltr text-right">
                                {lead.phone}
                              </a>
                            </div>
