            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-3 bg-background border rounded-xl text-sm font-extrabold focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                />
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-3 bg-background border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all rounded-xl text-sm font-mono font-black text-left focus:outline-none focus:border-indigo-600  focus:ring-2 focus:ring-indigo-500/20 placeholder:text-text-muted dark:placeholder:text-slate-500 transition-all"
                />
