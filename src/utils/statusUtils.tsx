...
export const STATUS_PERSIAN_MAP: Record<string, string> = {
  ...
  // Orders Statuses
  WAITING_SHIPPING_COST: "در انتظار تعیین کرایه ارسال",
  PENDING_PAYMENT: "در انتظار پرداخت",
  WAITING_FOR_PAYMENT: "در انتظار پرداخت",
  WAITING_SHIPPING_PAYMENT: "در انتظار پرداخت کرایه پستی",
  SUPPLIER_APPROVED: "تایید شده توسط تامین‌کننده",
  PAID: "پرداخت شده",
  PENDING_POSTAL_LABEL: "در انتظار صدور برچسب پستی",
