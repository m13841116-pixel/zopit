...
// 1. Remove StoreProAccountStep2 import and component entirely
...
// We also need to import Volume2 if not already there
if (!code.includes('Volume2')) {
  code = code.replace('from "lucide-react";', ', Volume2 } from "lucide-react";');
}

// 3. Transform the wizard form (formStep > 1)
// We will locate the whole wizard form and rewrite it completely.
// Wait, regex might be tricky. Let's just do it manually with multi_edit_file or exact string replacement in python.
